...
1. **readmission** — effect size +0.0002, DOES NOT PASS
2. **assistments** — effect size -0.0399, DOES NOT PASS
...
|---|---|---|---|---|
| readmission | 0 | +0.0000 | +0.0474 | 0.1% |
| readmission | 1 | +0.0004 | +0.0254 | 1.4% |
